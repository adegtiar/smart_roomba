...
IPAddress mqtt_addr(192, 168, 1, 253);
...
void startCleaning()
{
  Serial.println("*****Sending cleaning command*****");
  Serial.write(128);
  delay(50);
  Serial.write(131);
  delay(50);
  ...
  Serial.println("*****Done sending cleaning command. Publishing status*****");
}
...
void stopCleaning()
{
  ...
  Serial.println("*****Done sending stop command. Publishing status*****");
}

void sendInfoRoomba()
{
  Serial.println("*****Getting info from roomba sensors*****");
  roomba.start(); 
  ...
  {
    Serial.println("*****Got battery info. Publishing*****");
  ...
  if(battery_Total_mAh == 0)
  {
    Serial.println("*****Failed to get battery info. Publishing error*****");
  ...
  Serial.println("*****Finished loop, sending final info*****");
}
